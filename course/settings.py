"""
Django settings for courseRegApp project.
...
SECRET_KEY = 'django-insecure-szdjca&3m@z4**f7=8db9_v&4@ud++p_2+wom04-9smiof6^^2'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'olonilua.eo@achievers.edu.ng'  # Your email
